...
start:
    ...
    Dialog "password_for_netyaga", "Courier New", 14, \
           WS_SYSMENU or WS_OVERLAPPED or DS_CENTER, 4, 20, 20, 200, 120, 4466
    DlgStatic "put_password_for_netyaga", SS_CENTER, 10, 15, 180, 20, 445
    DlgEdit WS_BORDER or ES_PASSWORD, 10, 40, 180, 25, 1983
    DlgButton "Cancel", WS_TABSTOP, 20, 80, 70, 30, 2  
