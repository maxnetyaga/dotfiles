...
.data
    ...
    a1_crypt db "AS@GBYEm]QAOV_X", 0
    a2 db "1234567891123456789", 0
...
WinMain:
    ; Initialize pointers
    lea esi, a1_crypt ; Point to the first string
    lea edi, a2         ; Point to the second string
    lea ebx, result     ; Point to the result buffer
