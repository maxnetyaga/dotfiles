...
include 4-14-IM-34-Netyaga-inc.inc
.data
...
x2 proc h1:dword, u1:dword, w1:dword, l1:dword
    ...
    .endif
        .if w1 == 8
                ...
                cmpr__ a1_netyaga, netyaga_c1_netyaga ;invoke lstrcmp, offset a1_netyaga, offset netyaga_c1_netyaga
                .if EAX == 0
                lst_inf_ b2_netyaga, b1_netyaga ; invoke MessageBoxW, 0, offset b2_netyaga, offset b1_netyaga, 0
