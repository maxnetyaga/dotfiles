...
.data?
    hInstance HINSTANCE ?
    NET_NUM1_NETYAGA dt ?
    NET_NU_NETYAGA_M2__NETYAGA dt ?
    NETYAGA_DENO_NETYAGA_MINATOR_NETYAGA dt ?
.data
...
NumeratorFirstPart proc
    ...
    fld REAL10 ptr [edx]
    fmul
    fstp NET_NUM1_NETYAGA
    mov ecx, offset NET_NUM1_NETYAGA
    fclex
    ret
...
CalculateAndDisplay proc hWnd:HWND
    ...
    .while esi < 6
        ...
        fstp NET_NU_NETYAGA_M2__NETYAGA
        call NetyagaDenominatorNetyaga
        fstp NETYAGA_DENO_NETYAGA_MINATOR_NETYAGA
        fld NET_NU_NETYAGA_M2__NETYAGA
        fld NET_NUM1_NETYAGA
        faddp st(1), st(0)
        fld NETYAGA_DENO_NETYAGA_MINATOR_NETYAGA
        ftst
        fstsw ax
        sahf
        je div_zero_error
